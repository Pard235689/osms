...
<body>
 ...
 <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
  ...
  <span class="navbar-text" style="color:aqua">Customer's Happiness is our Aim</span>
  ...
  <div>
   <a  class="navbar-brand navbar-right" href="Admin/login.php" style="font-size: 16px; color:blue">Admin Login</a>
  </div>
 </nav> <!-- End Navigation -->

 <!-- Start Header Jumbotron-->
 <header class="jumbotron back-image" style="background-image:url(images/abcd.avif);">
 ...
 <div class="container" id="Contact">
  ...
  <div class="row">
   ...
   <div class="col-md-4 text-center"> <!-- Start 2nd Column -->
    ...
    OSMS Pvt Ltd,<br>
    Charbagh Lucknow<br>
    Uttar Pradesh - 201855<br>
    Phone: +91 xxxxxxxx37<br>
    <a href="#" target="_blank">www.osms.com</a><br>
    <br> <br>
    <strong>Branch:</strong><br>
    OSMS Pvt Ltd,<br>
    Vikas Nagar Kanpur<br>
    Uttar Pradesh - 208024<br>
    Phone: +91 xxxxxxxx77<br>
    <a href="#" target="_blank">www.osms.com</a><br>    
   </div> <!-- End 2nd Column -->
  </div>
 </div> <!-- End Contact US -->
...
<!-- <div>
<iframe width="560" height="315" src="https://www.youtube.com/embed/8K_Z0lisn6Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  ...
  <div class="container">
   <div class="row py-3">
    ...
    <div class="col-md-6 text-right"> <!-- Start 2nd Column -->
     <small>Designed by Praduman Kushwaha &copy; 2023</small>
